...
class CommandsService {
    constructor($analyticsSettingsService, $errors, $hooksService, $injector, $logger, $options, $staticConfig, $helpService, $extensibilityService, $optionsTracker, $projectDataService) {
