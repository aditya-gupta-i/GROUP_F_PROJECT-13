...
class DevicesService extends events_1.EventEmitter {
    constructor($logger, $errors, $iOSSimulatorDiscovery, $iOSDeviceDiscovery, $androidDeviceDiscovery, $staticConfig, $messages, $mobileHelper, $deviceLogProvider, $hostInfo, $injector, $options, $androidProcessService, $iOSEmulatorServices, $androidEmulatorServices, $androidEmulatorDiscovery, $emulatorHelper, $prompter, $timers) {
        super();
        this.$logger = $logger;
        this.$errors = $errors;
    ...
    startDeviceDetectionInterval(deviceInitOpts = {}) {
        if (!this.deviceDetectionInterval) {
            ...
            this.deviceDetectionInterval = this.$timers.setInterval(() => __awaiter(this, void 0, void 0, function* () {
    ...
    startEmulatorDetectionInterval(opts = {}) {
        ...
        this.emulatorDetectionInterval = this.$timers.setInterval(() => __awaiter(this, void 0, void 0, function* () {
