...
class IOSDeviceBase {
    ...
    getDebugSocket(appId, projectName, ensureAppStarted = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.$lockService.executeActionWithLock(() => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.attachToDebuggerFoundEvent(appId, projectName);
                if (ensureAppStarted) {
                    yield this.applicationManager.startApplication({ appId, projectName });
                }
    ...
    attachToDebuggerFoundEvent(appId, projectName) {
        return __awaiter(this, void 0, void 0, function* () {
