...
class Options {
    constructor($errors, $staticConfig, $settingsService) {
        this.$errors = $errors;
    ...
    get commonOptions() {
        return {
            ...
            platformTemplate: { type: "string", hasSensitiveValue: true },
            ...
            syncAllFiles: { type: "boolean", default: false, hasSensitiveValue: false },
            ...
            hmr: { type: "boolean", hasSensitiveValue: false },
            ...
            companion: { type: "boolean", hasSensitiveValue: false },
