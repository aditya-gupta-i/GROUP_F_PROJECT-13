...
class LiveSyncService extends events_1.EventEmitter {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (liveSyncProcessInfo && !liveSyncProcessInfo.isStopped) {
                ...
                _.each(removedDeviceIdentifiers, deviceIdentifier => {
                    this.emitLivesyncEvent(constants_1.LiveSyncEvents.liveSyncStopped, { projectDir, deviceIdentifier });
                });
            }
        });
    }
    ...
    attachToPreviewAppLiveSyncError() {
        if (!this.$usbLiveSyncService.isInitialized) {
            this.$previewAppLiveSyncService.on(constants_1.LiveSyncEvents.previewAppLiveSyncError, liveSyncData => {
                this.$logger.error(liveSyncData.error);
                this.emit(constants_1.LiveSyncEvents.previewAppLiveSyncError, liveSyncData);
            });
        }
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!settings || !settings.shouldSkipEmitLiveSyncNotification) {
                    this.emitLivesyncEvent(constants_1.LiveSyncEvents.liveSyncNotification, {
            ...
            this.emitLivesyncEvent(constants_1.LiveSyncEvents.liveSyncExecuted, {
                projectDir: projectData.projectDir,
                applicationIdentifier,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deviceAction = (device) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    this.emitLivesyncEvent(constants_1.LiveSyncEvents.liveSyncStarted, {
                        projectDir: projectData.projectDir,
                    ...
                    this.emitLivesyncEvent(constants_1.LiveSyncEvents.liveSyncError, {
                        error: err,
                        deviceIdentifier: device.deviceInfo.identifier,
                        projectDir: projectData.projectDir,
                        applicationIdentifier: projectData.projectIdentifiers[platform.toLowerCase()]
