...
class IOSDeviceLiveSyncService extends device_livesync_service_base_1.DeviceLiveSyncServiceBase {
    constructor($logger, $processService, $platformsData, device) {
    ...
    setupSocketIfNeeded(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.socket = yield this.device.getDebugSocket(appId, projectData.projectName, ensureAppStarted);
            }
            catch (err) {
    ...
    shouldRestart(projectData, liveSyncInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (liveSyncInfo.isFullSync || liveSyncInfo.waitForDebugger) {
                ...
                if (!canExecuteFastSync || !(yield this.setupSocketIfNeeded(projectData))) {
                    shouldRestart = true;
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (yield this.setupSocketIfNeeded(projectData)) {
                    yield this.reloadPage(otherFiles);
                }
                else {
                    didRefresh = false;
                }
