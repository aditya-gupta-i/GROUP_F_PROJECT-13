...
class PlatformService extends events_1.EventEmitter {
    constructor($devicesService, $preparePlatformNativeService, $preparePlatformJSService, $errors, $fs, $logger, $doctorService, $packageInstallationManager, $platformsData, $projectDataService, $pluginsService, $projectFilesManager, $mobileHelper, $hostInfo, $devicePathProvider, $devicePlatformsConstants, $projectChangesService, $analyticsService, $terminalSpinnerService, $pacoteService, $usbLiveSyncService, $hooksService) {
        super();
    ...
    preparePlatform(platformInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (shouldPrepare) {
                ...
                yield this.preparePlatformCore(platformInfo.platform, platformInfo.appFilesUpdaterOptions, platformInfo.projectData, platformInfo.config, platformInfo.env, changesInfo, platformInfo.filesToSync, platformInfo.filesToRemove, platformInfo.nativePrepare);
    ...
    preparePlatformCore(platform, appFilesUpdaterOptions, projectData, platformSpecificData, env, changesInfo, filesToSync, filesToRemove, nativePrepare) {
        return __awaiter(this, void 0, void 0, function* () {
